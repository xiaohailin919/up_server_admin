...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card-box">
                ...
                <form onsubmit="return submitForm()">
                        ...
                        <div class="form-group col-md-5">
                            <div class="mt-3">
                                <label class="custom-control custom-radio col-md-3">
                                    <input class="custom-control-input" name="rule_type" value="1" type="radio" onclick="onRuleTypeChange(this)" @if($data['placement_id'] === 0) checked @endif>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Platform</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input class="custom-control-input" name="rule_type" value="2" type="radio" onclick="onRuleTypeChange(this)" @if($data['placement_id'] !== 0) checked @endif>
                                    <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-row" id="platform-multi-select" @if($data['placement_id'] !== 0) hidden @endif>
                        <label class="form-group col-md-1">系统平台</label>
                        <div class="form-group col-md-5">
                            <div class="mt-3 row">
                                <label class="custom-control custom-checkbox col-md-3">
                                    <input class="custom-control-input" name="platform[]" value="1" type="checkbox" @if($data['platform'] === 1) checked @endif>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Android</span>
                                </label>
                                <label class="custom-control custom-checkbox">
                                    <input class="custom-control-input" name="platform[]" value="2" type="checkbox" @if($data['platform'] === 2) checked @endif>
                                    <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-row" id="placement-input" @if($data['placement_id'] === 0) hidden @endif>
                    ...
                    <div class="form-row" id="format-rows" @if($data['placement_id'] !== 0) hidden @endif>
                        <label class="form-group col-md-1">广告类型</label>
                        <div class="form-group col-md-5">
                            {{-- 广告类型主选列表：控制广告类型多选列表 --}}
                            <div class="mt-3">
                                <label class="custom-control custom-radio col-md-3">
                                    <input class="custom-control-input" name="format_radio" value="all" type="radio" onclick="showFormatsSelect(false)" @if($data['format'] === -1) checked @endif>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">全部</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input class="custom-control-input" name="format_radio" value="cus" type="radio" onclick="showFormatsSelect(true)" @if($data['format'] !== -1) checked @endif>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">
                                        指定广告类型
                                        <span class="sdk-notice-inline" id="custom-format-helper" @if($data['format'] === -1) hidden @endif>(点击清空)</span>
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-row" id="format-multi-select" @if($data['placement_id'] !== 0 || $data['format'] === -1) hidden @endif>
                        <label class="form-group col-md-1"></label>
                        <div class="form-group col-md-5">
                            <div class="mt-3 row" style="justify-content: space-between">
                                @foreach($formatMap as $key => $val)
                                    <label class="custom-control custom-checkbox">
                                        <input class="custom-control-input" name="format[]" value="{{ $key }}" type="checkbox" @if($data['format'] === $key) checked @endif>
                                        <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                            <div class="mt-3">
                                <label class="custom-control custom-radio col-md-3">
                                    <input class="custom-control-input" name="nw_firm_radio" value="all" type="radio" onclick="showNwFirmInput(false)" @if($data['nw_firm_id'] === 0) checked @endif>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">所有</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input class="custom-control-input" name="nw_firm_radio" value="cus" type="radio" onclick="showNwFirmInput(true)" @if($data['nw_firm_id'] !== 0) checked @endif>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">
                                        指定广告平台
                                        <span class="sdk-notice-inline" id="custom-nw-firm-helper" @if($data['nw_firm_id'] === 0) hidden @endif>(点击清空)</span>
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-row" id="nw-firm-multi-input" @if($data['nw_firm_id'] === 0) hidden @endif>
                        <label class="form-group col-md-1"></label>
                        <div class="form-group col-md-5">
    ...
    <script>
        jQuery(document).ready(function () {
            let selects = $('.select2');
            $(selects[0]).select2().val(['{{ $data['nw_firm_id'] }}']).trigger('change');
        });
                            ...
                            $.confirm({
                                ...
                                buttons: {
                                    ok: {
                                        ...
                                        action: function() {
                                            location.href = location.href.replace(/\/copy\/[0-9]*/, '');
                                        }
                                    },
                                    cancel: {
                                        text: '继续创建',
